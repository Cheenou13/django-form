"""
Django settings for parking_logs project.
...
INSTALLED_APPS = [
    ...
    'django.contrib.messages', 'django.contrib.staticfiles', 'parking_logs'
]
...
ROOT_URLCONF = 'parking_logs.urls'
...
WSGI_APPLICATION = 'parking_logs.wsgi.application'
